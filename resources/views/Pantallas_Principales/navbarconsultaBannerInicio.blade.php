...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <nav class="nav" id="nav-menu">
        <div class="nav__content bd-grid">
            ...
            <div class="nav__menu">
                ...
                <li class="nav__item"><a href="{{url('/consultaAlumnoM')}}" class="nav__link">ALUMNOS REGISTRADOS</a></li>                   <li class="nav__item"><a href="{{url('/RegisterFormRoles')}}" class="nav__link">NUEVO ADMIN</a></li>
    ...
    <section class="section-main">
      <h1>Consulta Imagenes Banner Home </h1>
    </section>
