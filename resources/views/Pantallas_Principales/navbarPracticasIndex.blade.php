    ...
    <header class="header">
      ...
      <nav class="nav" id="nav-menu">
        <div class="nav__content bd-grid">
            ...
            <div class="nav__menu">
                <ul class="nav__list">
                    <li class="nav__item"><a href="{{url('/Index_gnral')}}" class="nav__link">HOME</a></li>
                    ...
                    <li class="nav__item"><a href="{{url('/PracticasIndex')}}" class="nav__link  active">PRÁCTICAS</a></li>
