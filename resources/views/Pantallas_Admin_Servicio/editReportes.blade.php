...
<!-- Diseño de gladys -->
<h1>Validación Indivudual de Reporte Mensual</h1>
<table class="datos">
    <thead>
        <tr>
...
<form method="POST" action="{{ route('UpdateReportes.update',$docs->id) }}" enctype="multipart/form-data">
    @csrf
<table class="container">
    <thead>
            ...
            <th><h1>Estado</h1></th>
            <td>
                <textarea disabled rows="1" cols="1"class="estado">El reporte se encuentra: {{$docs->estado ? 'Validado': 'Sin Validar'}}
                </textarea>
