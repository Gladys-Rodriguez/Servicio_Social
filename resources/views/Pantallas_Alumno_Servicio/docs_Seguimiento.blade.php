...
@endforeach
        ...
        <p name="" id="" cols="1" rows="3" class="border rounded" >
            En caso de que alguno de tus documentos sea erroneos, puedes eliminarlo para volverlo a subir de la manera correcta.
        </p>
        <div class="table-responsive">
            ...
            <tbody>
              ...
              @endforeach
                  ...
                  <h2>Control de Liberación </span> </h2>
                  <br>
                      ...
                      <tbody>
                          ...
                          @foreach ($liberaciones as $alum)
                                          <tr>
                                              <td>
                                                 Actualmente se encuentra: {{$alum->estado  ? 'Aceptado': 'Sin Validar'}}
                                                  </td>
                                              <td>{{$alum->fecha_envio}}</td>
                                              <td>{{$alum->observaciones}}</td>
