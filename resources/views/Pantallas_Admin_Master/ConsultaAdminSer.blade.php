@extends('Pantallas_Admin_Master.navbar_ConsultaAdminSer')
...
@section('content')
<h1>REGISTRO DE ADMINISTADORES DE SERVICIO</h1>
<hr><br>
<table>
	    	<thead>
		    	<tr>
			...
			@foreach ($datos as $dato)
		    	<tr> 
					...
					<td><form action="/BorraUserSer/{{$dato->id}}" method="POST" enctype="multipart/form-data">
          			@csrf
