...
<header class="header">
    ...
    <nav class="nav" id="nav-menu">
        <div class="nav_content bd-grid">
           ...
           <div class="nav_menu">
               <ul class="nav_list">
                   <li class="nav_item"><a href="{{url('/Admin_Practicas_Visitas_Index')}}" class="nav_link active"><i class="fas fa-home"></i>INICIO</a></li>
                   <li class="nav_item"><a href="{{url('/Validacion_Practicas_Visitas')}}" class="nav_link"><i class="fas fa-bus"></i>Validación Documentos Practicas y Visitas</a></li>
