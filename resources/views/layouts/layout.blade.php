...
<!--    </ul>
    ...
    <div class="nombreEscuela-contenedor fixed-top-menuManual fixed-top">
        <div class="container u-noPaddingContainer">
            <p class="nombreEscuela-titulo">CECyT 13 "Ricardo Flores Magón"</p>
        </div>
    </div>
    ...
    <div class="bg--blanco">
        ...
        <a href="https://www.facebook.com/ricardo.floresmagon.1023611" target="_blank">
            <svg class="svg-inline--fa fa-facebook-f fa-w-16" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="facebook" aria-hidden="true" data-prefix="fab" data-icon="facebook-f" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><defs><clipPath id="clip-2"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></clipPath><mask x="0" y="0" width="100%" height="100%" id="mask-1" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse"><rect x="0" y="0" width="100%" height="100%" fill="white"></rect><g transform="translate(256 256)"><g transform="translate(0, 0)  scale(0.59375, 0.59375)  rotate(0 0 0)"><path fill="black" d="M76.7 512V283H0v-91h76.7v-71.7C76.7 42.4 124.3 0 193.8 0c33.3 0 61.9 2.5 70.2 3.6V85h-48.2c-37.8 0-45.1 18-45.1 44.3V192H256l-11.7 91h-73.6v229" transform="translate(-132 -256)"></path></g></g></mask></defs><rect fill="currentColor" clip-path="url(#clip-2)" mask="url(#mask-1)" x="0" y="0" width="100%" height="100%"></rect></svg><!-- <i class="fab fa-facebook-f" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="facebook"></i> -->
        </a>

        <a href="https://twitter.com/Cecyt13R" target="_blank">
            <svg class="svg-inline--fa fa-twitter fa-w-16" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Twitter" aria-hidden="true" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><defs><clipPath id="clip-4"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></clipPath><mask x="0" y="0" width="100%" height="100%" id="mask-3" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse"><rect x="0" y="0" width="100%" height="100%" fill="white"></rect><g transform="translate(256 256)"><g transform="translate(0, 0)  scale(0.59375, 0.59375)  rotate(0 0 0)"><path fill="black" d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z" transform="translate(-256 -256)"></path></g></g></mask></defs><rect fill="currentColor" clip-path="url(#clip-4)" mask="url(#mask-3)" x="0" y="0" width="100%" height="100%"></rect></svg><!-- <i class="fab fa-twitter" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Twitter"></i> -->
        </a>

        <a href="https://www.youtube.com/channel/UCSGQ9Z8q44MfgVlJztRNp8A" target="_blank">
            <svg class="svg-inline--fa fa-youtube fa-w-16" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Youtube" aria-hidden="true" data-prefix="fab" data-icon="youtube" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><defs><clipPath id="clip-6"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></clipPath><mask x="0" y="0" width="100%" height="100%" id="mask-5" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse"><rect x="0" y="0" width="100%" height="100%" fill="white"></rect><g transform="translate(256 256)"><g transform="translate(0, 0)  scale(0.59375, 0.59375)  rotate(0 0 0)"><path fill="black" d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z" transform="translate(-288 -256)"></path></g></g></mask></defs><rect fill="currentColor" clip-path="url(#clip-6)" mask="url(#mask-5)" x="0" y="0" width="100%" height="100%"></rect></svg><!-- <i class="fab fa-youtube" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Youtube"></i> -->
        </a>

        <a href="https://drive.google.com/drive/folders/0B5ZnKEA3fhgkd1VybF9kcU1mM2s" target="_blank">
            <svg class="svg-inline--fa fa-google-plus fa-w-16" alt="Google plus" aria-hidden="true" data-prefix="fab" data-icon="google-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" data-fa-i2svg=""><path fill="currentColor" d="M248 8C111.1 8 0 119.1 0 256s111.1 248 248 248 248-111.1 248-248S384.9 8 248 8zm-70.7 372c-68.8 0-124-55.5-124-124s55.2-124 124-124c31.3 0 60.1 11 83 32.3l-33.6 32.6c-13.2-12.9-31.3-19.1-49.4-19.1-42.9 0-77.2 35.5-77.2 78.1s34.2 78.1 77.2 78.1c32.6 0 64.9-19.1 70.1-53.3h-70.1v-42.6h116.9c1.3 6.8 1.9 13.6 1.9 20.7 0 70.8-47.5 121.2-118.8 121.2zm230.2-106.2v35.5H372v-35.5h-35.5v-35.5H372v-35.5h35.5v35.5h35.2v35.5h-35.2z"></path></svg><!-- <i class="fab fa-google-plus" alt="Google plus"></i> -->
        </a>

        <a href="" target="_blank" class="u-oculto">
            <svg class="svg-inline--fa fa-blogger-b fa-w-16" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Blogger" aria-hidden="true" data-prefix="fab" data-icon="blogger-b" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><defs><clipPath id="clip-8"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></clipPath><mask x="0" y="0" width="100%" height="100%" id="mask-7" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse"><rect x="0" y="0" width="100%" height="100%" fill="white"></rect><g transform="translate(256 256)"><g transform="translate(0, 0)  scale(0.59375, 0.59375)  rotate(0 0 0)"><path fill="black" d="M446.6 222.7c-1.8-8-6.8-15.4-12.5-18.5-1.8-1-13-2.2-25-2.7-20.1-.9-22.3-1.3-28.7-5-10.1-5.9-12.8-12.3-12.9-29.5-.1-33-13.8-63.7-40.9-91.3-19.3-19.7-40.9-33-65.5-40.5-5.9-1.8-19.1-2.4-63.3-2.9-69.4-.8-84.8.6-108.4 10C45.9 59.5 14.7 96.1 3.3 142.9 1.2 151.7.7 165.8.2 246.8c-.6 101.5.1 116.4 6.4 136.5 15.6 49.6 59.9 86.3 104.4 94.3 14.8 2.7 197.3 3.3 216 .8 32.5-4.4 58-17.5 81.9-41.9 17.3-17.7 28.1-36.8 35.2-62.1 4.9-17.6 4.5-142.8 2.5-151.7zm-322.1-63.6c7.8-7.9 10-8.2 58.8-8.2 43.9 0 45.4.1 51.8 3.4 9.3 4.7 13.4 11.3 13.4 21.9 0 9.5-3.8 16.2-12.3 21.6-4.6 2.9-7.3 3.1-50.3 3.3-26.5.2-47.7-.4-50.8-1.2-16.6-4.7-22.8-28.5-10.6-40.8zm191.8 199.8l-14.9 2.4-77.5.9c-68.1.8-87.3-.4-90.9-2-7.1-3.1-13.8-11.7-14.9-19.4-1.1-7.3 2.6-17.3 8.2-22.4 7.1-6.4 10.2-6.6 97.3-6.7 89.6-.1 89.1-.1 97.6 7.8 12.1 11.3 9.5 31.2-4.9 39.4z" transform="translate(-224 -256)"></path></g></g></mask></defs><rect fill="currentColor" clip-path="url(#clip-8)" mask="url(#mask-7)" x="0" y="0" width="100%" height="100%"></rect></svg><!-- <i class="fab fa-blogger-b" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Blogger"></i> -->
        </a>

        <a href="" target="_blank" class="u-oculto">
            <svg class="svg-inline--fa fa-rss fa-w-16" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="RSS" aria-hidden="true" data-prefix="fas" data-icon="rss" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><defs><clipPath id="clip-10"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></clipPath><mask x="0" y="0" width="100%" height="100%" id="mask-9" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse"><rect x="0" y="0" width="100%" height="100%" fill="white"></rect><g transform="translate(256 256)"><g transform="translate(0, 0)  scale(0.59375, 0.59375)  rotate(0 0 0)"><path fill="black" d="M128.081 415.959c0 35.369-28.672 64.041-64.041 64.041S0 451.328 0 415.959s28.672-64.041 64.041-64.041 64.04 28.673 64.04 64.041zm175.66 47.25c-8.354-154.6-132.185-278.587-286.95-286.95C7.656 175.765 0 183.105 0 192.253v48.069c0 8.415 6.49 15.472 14.887 16.018 111.832 7.284 201.473 96.702 208.772 208.772.547 8.397 7.604 14.887 16.018 14.887h48.069c9.149.001 16.489-7.655 15.995-16.79zm144.249.288C439.596 229.677 251.465 40.445 16.503 32.01 7.473 31.686 0 38.981 0 48.016v48.068c0 8.625 6.835 15.645 15.453 15.999 191.179 7.839 344.627 161.316 352.465 352.465.353 8.618 7.373 15.453 15.999 15.453h48.068c9.034-.001 16.329-7.474 16.005-16.504z" transform="translate(-224 -256)"></path></g></g></mask></defs><rect fill="currentColor" clip-path="url(#clip-10)" mask="url(#mask-9)" x="0" y="0" width="100%" height="100%"></rect></svg><!-- <i class="fas fa-rss" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="RSS"></i> -->
        </a>

        <a href="http://cecyt13_rfm_oficial" target="_blank">
            <svg class="svg-inline--fa fa-instagram fa-w-16" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Instagram" aria-hidden="true" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><defs><clipPath id="clip-12"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></clipPath><mask x="0" y="0" width="100%" height="100%" id="mask-11" maskUnits="userSpaceOnUse" maskContentUnits="userSpaceOnUse"><rect x="0" y="0" width="100%" height="100%" fill="white"></rect><g transform="translate(256 256)"><g transform="translate(0, 0)  scale(0.59375, 0.59375)  rotate(0 0 0)"><path fill="black" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z" transform="translate(-224 -256)"></path></g></g></mask></defs><rect fill="currentColor" clip-path="url(#clip-12)" mask="url(#mask-11)" x="0" y="0" width="100%" height="100%"></rect></svg><!-- <i class="fab fa-instagram" data-fa-transform="shrink-6.5" data-fa-mask="fas fa-circle" alt="Instagram"></i> -->
        </a>
    </div>
    ...
    <footer class="piePagina">
            ...
            <div class="container">
                <div class="row">
                   <!-- <div class="col-lg-2 piePagina-logoSep text-center mb-3">
                        <img src="/assets/files/main/img/firma-sep-vertical.jpg" alt="" class="img-fluid mb-3">
                        <div class="w-100"></div>
                ...
                <div class="row">
                      <div class="col-lg-12 pl-7">
                        <img src="{{asset('img/template/educacion2.png')}}" alt="SEP" class="EducacionplecaGob gob">
                     </div>
                </div>
            </div>
        </div>
        ...
        <span id="top-contenedor" style="display: inline;">
            <a href="#" class="top-link" onclick="$('html,body').animate({scrollTop:0},'slow');return false;">
                <svg class="svg-inline--fa fa-chevron-up fa-w-14" aria-hidden="true" data-prefix="fas" data-icon="chevron-up" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z"></path></svg><!-- <i class="fas fa-chevron-up"></i> -->
            </a>
        </span>
        <div class="container enlace-pie-ipn">
            <ul>
                <li>
                    <a href="https://www.ipn.mx/datosabiertos/" target="_blank">Datos Abiertos IPN</a>
                </li>
            </ul>
        </div>
